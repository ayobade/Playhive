    ...
    return (
       <FooterContainer>
        <FooterWrapper>
          ...
          <FooterContent>
            <BrandColumn>
              <Tagline>A hive where e-sports come alive!</Tagline>
              <Description>
                Level up your e-sports game. Host, play, and win like a pro at PlayHive! Ready to make some buzz? Join us now and host your first tournament for free!
              </Description>
              <SocialIcons>
